...
console.log('   Navigate to: https://snowpark.netlify.app/admin/catalog/attraction-slots');
...
console.log('   Navigate to: https://snowpark.netlify.app/admin/catalog/combo-slots');
